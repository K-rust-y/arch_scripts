...
sudo pacman -S  curl pcmanfm gvim remmina proxychains git coreutils feh flameshot iptables terminator bluez bluez-utils blueman unzip htop lshw pulseaudio alsa-utils pavucontrol xfce4-power-manager brightnessctl vlc libreoffice
